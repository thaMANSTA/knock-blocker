...
const crxUrlTemplate = 'https://github.com/thaMANSTA/knock-blocker/releases/download/${APP_VERSION}/knock-blocker-chrome-extension.crx';
...
crxUrl = crxUrlTemplate.replaceAll('${APP_VERSION}', 'v' + appVersion);
